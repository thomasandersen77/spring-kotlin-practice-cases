...
@SpringBootApplication class RegistrationApplication
...
class EventEntity(
	...
	@Column(nullable = false) var availableSeats: Int = 0,
) {
...
class RegistrationEntity(
	@Id @GeneratedValue(strategy = GenerationType.IDENTITY) var id: Long? = null,
	@Column(name = "event_id", nullable = false) var eventId: Long = 0,

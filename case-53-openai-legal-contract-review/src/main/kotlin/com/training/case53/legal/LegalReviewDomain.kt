...
class InvalidModelResponse(message: String, cause: Throwable? = null) :
	RuntimeException(message, cause)

class OpenAiUnavailable(cause: Throwable? = null) :
	RuntimeException("OpenAI er midlertidig utilgjengelig", cause)

...
/**
 * Koster penger og treffer en virkelig ekstern tjeneste. Bruk bare syntetiske data.
 * Testen er deaktivert med mindre RUN_OPENAI_LIVE_TEST=true finnes i prosessmiljøet.
 */
@Tag("live")
@SpringBootTest

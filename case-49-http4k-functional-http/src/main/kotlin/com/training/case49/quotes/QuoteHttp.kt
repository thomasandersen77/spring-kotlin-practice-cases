...
fun quoteRoutes(service: QuoteService): HttpHandler =
 TODO("Bygg funksjonell http4k-routing")

// TODO 3: Lag et Filter som gjenbruker/genererer X-Request-ID på alle responser.
fun requestIdFilter(): Filter =
 TODO("Implementer request-id-filter")

// TODO 4: Komponer dependencies eksplisitt uten container eller global tilstand.
fun quoteApp(service: QuoteService): HttpHandler =
 requestIdFilter().then(quoteRoutes(service))

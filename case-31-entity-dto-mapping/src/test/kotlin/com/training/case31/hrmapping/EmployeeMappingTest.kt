...
class EmployeeMappingTest {
 ...
 private val kari = EmployeeEntity(
 id = 1,
 firstName = "Kari",
 lastName = "Nordmann",
 ...
 private val ola = EmployeeEntity(
 id = 2,
 firstName = "Ola",
 lastName = "Hansen",
 ...
 private val liv = EmployeeEntity(
 id = 3,
 firstName = "Liv",
 lastName = "Berg",
 ...
 private val per = EmployeeEntity(
 id = 4,
 firstName = "Per",
 lastName = "Ås",
 ...
 assertThat(utviklingSummary.topCertifiedSkills).containsExactly("Kotlin", "AWS", "Spring Boot")
 }

 @Test
 fun `topCertifiedSkills begrenses av topSkillCount`() {
 val utviklingSummary = allEmployees
 .toDepartmentSummaries(today, topSkillCount = 1)
 .first { it.departmentName == "Utvikling" }

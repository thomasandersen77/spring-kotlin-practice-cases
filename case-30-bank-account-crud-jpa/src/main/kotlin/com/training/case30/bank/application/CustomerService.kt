...
class CustomerService(
	...
	@Transactional(readOnly = true) fun list(): List<Customer> = customerRepository.findAll()
	...
	fun update(customerId: CustomerId, name: String, email: String): Customer {
		...
		// TODO(case-30): håndter konflikt ved e-postendring hvis e-post allerede er i bruk av annen
		// kunde

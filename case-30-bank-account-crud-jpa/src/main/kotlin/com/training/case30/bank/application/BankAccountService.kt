...
class BankAccountService(
 ...
 @Transactional
 fun create(customerId: CustomerId, accountNumber: AccountNumber, displayName: String): BankAccount {
 ...
 customerId?.let { bankAccountRepository.findAllByCustomerId(it) } ?: bankAccountRepository.findAll()

...
class CustomerServiceTest {
    ...
    fun `update customer should fail when email belongs to another customer`() {
        val customerRepo = MutableCustomerRepository().also {
...
private class EmptyAccountRepository : BankAccountRepository {
    override fun save(account: com.interview.case30.bank.domain.BankAccount): com.interview.case30.bank.domain.BankAccount = account
    override fun findById(id: com.interview.case30.bank.domain.AccountId): com.interview.case30.bank.domain.BankAccount? = null
    override fun findAll(): List<com.interview.case30.bank.domain.BankAccount> = emptyList()
    override fun findAllByCustomerId(customerId: CustomerId): List<com.interview.case30.bank.domain.BankAccount> = emptyList()
    override fun existsByAccountNumber(accountNumber: com.interview.case30.bank.domain.AccountNumber): Boolean = false
    override fun existsByCustomerId(customerId: CustomerId): Boolean = false
    override fun deleteById(id: com.interview.case30.bank.domain.AccountId) {}
}

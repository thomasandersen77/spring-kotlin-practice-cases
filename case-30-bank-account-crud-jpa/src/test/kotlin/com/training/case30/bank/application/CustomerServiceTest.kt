...
private class EmptyAccountRepository : BankAccountRepository {
 override fun save(account: com.training.case30.bank.domain.BankAccount): com.training.case30.bank.domain.BankAccount = account
 override fun findById(id: com.training.case30.bank.domain.AccountId): com.training.case30.bank.domain.BankAccount? = null
 override fun findAll(): List<com.training.case30.bank.domain.BankAccount> = emptyList()
 override fun findAllByCustomerId(customerId: CustomerId): List<com.training.case30.bank.domain.BankAccount> = emptyList()
 override fun existsByAccountNumber(accountNumber: com.training.case30.bank.domain.AccountNumber): Boolean = false

...
import com.training.case36.bank.adapter.web.dto.ApiErrorResponse
import com.training.case36.bank.domain.BankingException
 ...
 * `Money`/`BankAccount` guard clauses) are already implemented - they are mechanical. TODO 14 is
 * the one that actually requires judgement: mapping each domain error code to the right HTTP
 * status.
 */

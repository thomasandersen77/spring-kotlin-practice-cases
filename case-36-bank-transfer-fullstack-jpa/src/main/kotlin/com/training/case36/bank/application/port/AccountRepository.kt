...
/**
 * Port that [com.training.case36.bank.application.BankingService] depends on instead of depending
 * on Spring Data directly (Dependency Inversion Principle). Implemented by

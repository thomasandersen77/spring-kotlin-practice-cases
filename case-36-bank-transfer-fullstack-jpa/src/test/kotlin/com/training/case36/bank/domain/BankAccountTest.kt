...
class BankAccountTest {
 ...
 private fun activeAccountWithBalance(balanceKroner: String): BankAccount = BankAccount.reconstitute(
 id = AccountId.new(),
 ...
 private fun blockedAccountWithBalance(balanceKroner: String): BankAccount = BankAccount.reconstitute(
 id = AccountId.new(),
 ownerName = "Kari Nordmann",

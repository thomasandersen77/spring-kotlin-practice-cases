package com.training.case36.bank.support
...
/**
 * Small, explicit test fixtures for case 36. Deliberately not a generic test framework - just a
 * couple of named helpers so test setup reads clearly. Each call produces a fresh account with a
 * random [AccountId], so tests never collide with data left behind by other tests sharing the same
 * H2 schema.
 */

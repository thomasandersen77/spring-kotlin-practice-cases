...
class NotificationDomainTest {
	...
	private val withoutSmsAndConsent =
		Recipient(
			id = "R2",
	...
	private val withoutContactInfo =
		Recipient(
			id = "R4",
			email = null,
			msisdn = null,
	...
	fun `varsler sorteres pa prioritet og beholder rekkefolgen innenfor samme prioritet`() {
		val sorted =
			listOf(marketing, orderShipped, passwordReset, paymentFailed).highestPriorityFirst()

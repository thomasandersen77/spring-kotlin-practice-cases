 ...
 *
 * Domenet kjenner kun porten LlmClient — aldri HTTP, JSON eller leverandørnavn. Dagens
 * CvScoringService kaller primærmodellen direkte uten feilhåndtering. Se README for TODO-er.
 */
...
/**
 * Porten. Adapteren (ikke del av dette caset) ville implementert denne mot Gemini/OpenAI over HTTP.
 * I testene brukes fakes.
 */
interface LlmClient {

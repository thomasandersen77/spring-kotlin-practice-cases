...
class ProviderUnavailable(cause: Throwable? = null) :
	RuntimeException("Leverandør utilgjengelig", cause)

class InvalidProviderResponse(message: String, cause: Throwable? = null) :
...
class RestClientCapacityAdapter(
	...
	override fun getCapacity(consultantId: String): ConsultantCapacity =
		TODO("Kall leverandør og map respons/feil")
}

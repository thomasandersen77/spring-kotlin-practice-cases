package com.interview.case44.security
...
class JwtAuthorityMapper : Converter<Jwt, Collection<GrantedAuthority>> {
    // TODO 1: Map permissions til SCOPE_* og roller til ROLE_*. Ignorer blanke/ukjente verdier bevisst.
...
class JwtSecurityConfig {
    ...
    fun filterChain(http: HttpSecurity, mapper: JwtAuthorityMapper): SecurityFilterChain {
        ...
        http
            ...
            .authorizeHttpRequests {
                it.requestMatchers(HttpMethod.GET, "/api/invoices/**").hasAuthority("SCOPE_invoices:read")
    ...
    @Bean
    fun jwtAuthorityMapper() = JwtAuthorityMapper()
}

...
@JvmInline value class BorrowerId(val value: String)
...
class Loan(
	...
	fun extend(days: Long): Loan {
		TODO(
			"Implement one-time extension with explicit state for whether extension is already used and validate positive day count"
		)
	}

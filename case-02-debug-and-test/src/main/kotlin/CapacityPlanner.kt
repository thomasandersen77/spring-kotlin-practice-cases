...
class CapacityController(private val planner: CapacityPlanner = CapacityPlanner()) {
...
data class CapacityResponse(val availableDays: Int)
...
class CapacityPlanner {
	 ...
	 * - Del gjerne opp i navngitte hjelpefunksjoner som uttrykker domenespråk (arbeidsdag, fravær,
	 *   periode).

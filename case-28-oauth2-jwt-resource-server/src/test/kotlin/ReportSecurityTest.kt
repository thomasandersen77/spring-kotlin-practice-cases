...
/**
 * Disse testene beskriver kontrakten for sikkerhetskonfigurasjonen. Flere FEILER med dagens
 * permitAll-konfigurasjon — det er selve oppgaven.
 */
...
class ReportSecurityTest {
	...
	@MockBean lateinit var jwtDecoder: JwtDecoder // mockes bort: ingen ekte IdP i test

 ...
 *
 * SecurityConfig er med vilje ufullstendig — alt slipper gjennom. Se README for TODO-er: JWT
 * resource server, scopes og rollemapping fra custom claim.
 */
@SpringBootApplication class ReportApp
...
class ReportController {
	...
	@GetMapping("/public/ping") fun ping(): Map<String, String> = mapOf("status" to "ok")

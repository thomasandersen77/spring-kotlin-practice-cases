...
class SalesReportTest {
	...
	private val tv =
		OrderLine("TV-55", "TV 55 tommer", "Elektronikk", quantity = 1, unitPriceOre = 899_900)
	private val hdmiTwo =
		OrderLine("HDMI", "HDMI-kabel", "Elektronikk", quantity = 2, unitPriceOre = 19_900)
	private val hdmiThree =
		OrderLine("HDMI", "HDMI-kabel", "Elektronikk", quantity = 3, unitPriceOre = 19_900)
	private val socksFive =
		OrderLine("SOKK", "Ullsokker", "Klær", quantity = 5, unitPriceOre = 14_900)
	private val socksTwo =
		OrderLine("SOKK", "Ullsokker", "Klær", quantity = 2, unitPriceOre = 14_900)
	private val mouseOne =
		OrderLine("MUS", "Trådløs mus", "Elektronikk", quantity = 1, unitPriceOre = 49_900)
	private val mouseFour =
		OrderLine("MUS", "Trådløs mus", "Elektronikk", quantity = 4, unitPriceOre = 49_900)
	...
	fun `bestselgere sorteres pa antall og deretter sku`() {
		assertThat(orders.topSellingSkus(limit = 3))
			.containsExactly(
	...
	fun `daglig omsetning har lopende sum og ingen tomme dager`() {
		assertThat(orders.dailyRevenue())
			.containsExactly(
				DailyRevenue(
					LocalDate.of(2026, 7, 1),
					revenueOre = 1_073_900,
					cumulativeRevenueOre = 1_073_900,
				),
				DailyRevenue(
					LocalDate.of(2026, 7, 2),
					revenueOre = 79_700,
					cumulativeRevenueOre = 1_153_600,
				),
				DailyRevenue(
					LocalDate.of(2026, 7, 4),
					revenueOre = 199_600,
					cumulativeRevenueOre = 1_353_200,
				),
			)
	}
